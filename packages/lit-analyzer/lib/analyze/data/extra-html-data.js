...
function stringToSimpleType(typeString, name) {
    if (Array.isArray(typeString)) {
        ...
        return {
            kind: "UNION",
            types: typeString.map(value => ({ kind: "STRING_LITERAL", value }))
        };
    }
...
//# sourceMappingURL=extra-html-data.js.map