...
exports.RULE_ID_CODE_MAP = exports.ALL_RULE_IDS = void 0;
...
exports.RULE_ID_CODE_MAP = exports.ALL_RULE_IDS.reduce((acc, ruleId, i) => {
    acc[ruleId] = i + 2300;
    return acc;
}, {});
...
function getDefaultRules(userOptions) {
    ...
    return exports.ALL_RULE_IDS.reduce((acc, ruleId) => {
...
//# sourceMappingURL=lit-analyzer-config.js.map