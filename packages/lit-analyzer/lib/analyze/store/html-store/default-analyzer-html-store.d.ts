import type { HtmlAttr, HtmlAttrTarget, HtmlCssPart, HtmlDataCollection, HtmlEvent, HtmlMember, HtmlProp, HtmlSlot, HtmlTag, NamedHtmlDataCollection } from "../../parse/parse-html-data/html-tag.js";
import type { HtmlNodeAttr, IHtmlNodeAttr, IHtmlNodeAttrEventListener, IHtmlNodeAttrProp, IHtmlNodeBooleanAttribute } from "../../types/html-node/html-node-attr-types.js";
