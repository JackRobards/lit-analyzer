...
export class CodeDiagnosticFormatter {
    report(stats) {
...
function diagnosticTextForFile(file, diagnostic) {
    ...
    const highlightingColorFunction = (str) => chalk.black(diagnostic.severity === "error" ? chalk.bgRedBright(str) : chalk.bgYellow(str));
...
//# sourceMappingURL=code-diagnostic-formatter.mjs.map