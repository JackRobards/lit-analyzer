    ...
    if (!(0, is_lit_directive_js_1.isLit2Directive)(type) && type.kind !== "ANY") {
        if ((0, is_lit_directive_js_1.isLit1Directive)(type)) {
            context.report({
                ...
                message: `Type '${(0, ts_simple_type_1.typeToString)(type)}' is a lit-html 1.0 directive, not a Lit 2 directive'`
            });
        }
        else {
            context.report({
                location: (0, range_util_js_1.rangeFromHtmlNodeAttr)(htmlAttr),
                message: `Type '${(0, ts_simple_type_1.typeToString)(type)}' is not a Lit 2 directive'`
            });
        }
        return false;
    }
...
//# sourceMappingURL=is-assignable-in-element-binding.js.map