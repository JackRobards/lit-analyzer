...
import type { IAtDirectiveData, ICSSDataProvider, IPropertyData, IPseudoClassData, IPseudoElementData } from "vscode-css-languageservice";
...
import type { LitTargetKind } from "../../types/lit-target-kind.js";
